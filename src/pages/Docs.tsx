...
export default function Docs() {
  ...
  if (error) {
    return (
      <div className="min-h-[calc(100vh-64px)] pt-32 px-12 text-center">
        <h1 className="text-3xl font-bold text-white tracking-tight mb-4">
          Docs not found
        </h1>
        <p className="text-theme-muted">
          Ensure you have created the docs/index.md file.
        </p>
      </div>
    );
  }
  ...
  if (content === null) {
    return (
      <div className="min-h-[calc(100vh-64px)] pt-24 pb-32">
        <div className="px-8 md:px-16 max-w-4xl mx-auto w-full animate-pulse">
  ...
  return (
    <div className="flex flex-1 max-w-[1240px] mx-auto w-full min-h-[calc(100vh-64px)]">
      <article className="flex-1 min-w-0 pt-24 pb-32 px-8 md:px-12 w-full prose-zlynx">
        <ReactMarkdown
          ...
          components={{
            ...
            h2: ({ children }) => {
              ...
              return (
                <h2
                  id={id}
                  className="text-2xl font-bold text-white tracking-tight mt-16 mb-6 pb-2 border-b border-theme-border scroll-mt-24"
                >
                  {children}
                </h2>
              );
      ...
      {headings.length > 0 && (
        <aside className="w-56 hidden xl:block shrink-0 pt-24 pr-8 sticky top-16 h-[calc(100vh-64px)] overflow-y-auto custom-scrollbar">
